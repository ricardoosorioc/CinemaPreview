package com.example.cinema.Controlers;
...
public class SwipeButton extends RelativeLayout {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        disabledDrawable = ContextCompat.getDrawable(getContext(), R.drawable.ic_baseline_local_movies_24);
        enabledDrawable = ContextCompat.getDrawable(getContext(), R.drawable.ic_baseline_local_movies_24);
